	  ...
	  this.innerHTML = `
		...
		<footer>
			<ul class="footer-row">
				...
				<li><img class="u-logo" src="https://andremchang.github.io/assets/designedby.png" width="200px" height="67px" alt=""/> <img class="u-logo" src="https://andremchang.github.io/assets/writtenby.png" width="200px" height="67px" alt=""/></li>
